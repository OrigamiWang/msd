module github.com/OrigamiWang/msd/gate

go 1.20

require (
	github.com/OrigamiWang/msd/gorm-demo v0.0.0-20240130110858-380403841cfa
	github.com/OrigamiWang/msd/micro v0.0.0-20240130105659-1794d1ba4627
	github.com/gin-gonic/gin v1.9.1
)

require (
	github.com/OrigamiWang/msd/manage v0.0.0-20240130111522-d8b6908a5849 // indirect
